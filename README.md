...
This repository begins with a verified implementation of the ideal three-qubit
bit-flip repetition code in Qiskit Aer. Later stages will add coherent gate
errors and syndrome-informed calibration.
...
## What the ideal implementation contains
...
The notebook draws the circuit, constructs the complete syndrome truth table,
plots syndrome histograms, and verifies active recovery.
